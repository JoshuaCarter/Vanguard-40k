...
Instead of targeting an enemy unit with a ranged weapon, you may optionally select an enemy model and target all enemy models within 3" that have the same ***Unit Name*** as though they were a unit.
